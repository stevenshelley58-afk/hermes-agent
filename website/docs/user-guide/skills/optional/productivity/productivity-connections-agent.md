---
title: "Connections Agent — Plan and execute safe provider connection changes"
sidebar_label: "Connections Agent"
...
Plan and execute safe provider connection changes.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/connections-agent` |
| Path | `optional-skills/productivity\connections-agent` |
| Version | `0.1.0` |
